...
-gtf: if you want to know in which genes the m6A sites are found, provide a bed file with the gene start and end coordinates and with a gene identifier at your choice (gene name, gene ID... etc)
